...
void *threadlight(void *data)
{
    ...
    while(1)
	{
        ...
        if(adcValue_light >= 1500) ledvalue =100;
		else if(adcValue_light >= 1400) ledvalue = 90;
        else if(adcValue_light >= 1300) ledvalue = 80;
        else if(adcValue_light >= 1200) ledvalue = 70;
        else if(adcValue_light >= 1100) ledvalue = 60;
        else if(adcValue_light >= 1000) ledvalue = 50;
        else if(adcValue_light >= 900) ledvalue = 40;
        else if(adcValue_light >= 800) ledvalue = 30;
        else if(adcValue_light >= 700) ledvalue = 20;
        else if(adcValue_light >= 600) ledvalue = 10;
        else if(adcValue_light >= 500) ledvalue = 0;
...
void *threadrgb(void *data)
{
	...
	while(1)
	{
		...
		if(strcmp(buf,"red\n")==0)setRGB(255,162,057);
		if(strcmp(buf,"blue\n")==0)setRGB(200,250,255);
		if(strcmp(buf,"white\n")==0)setRGB(255,250,220);
		if(strcmp(buf,"none\n")==0)setRGB(0,0,0);
...
{	
	...
	while(1)
	{
		...
		if ((j >= 40) && (dht22_dat[4] == ((dht22_dat[0] + dht22_dat[1] + dht22_dat[2] + dht22_dat[3]) & 0xFF)) ) 
		{
			...
			if(t > 20.0) digitalWrite(FAN, 1);
			else if(t < 15.0) digitalWrite(FAN, 0);
